            ...
            @endfor
              ...
              <!-- <tr style="text-align: center;" role="row" class="odd">
                <input type="hidden" name="counter" value="0">
                  ...
                  <td>
                      <select name="employee_id[]" id="employee_name" class="form-control select2 select2-hidden-accessible" style="width: 100%;" tabindex="-1" aria-hidden="true">
                  ...
                  @for ($i = 1; $i <=31; $i++)
                      <td>
                          <input name="start_time_<?php echo $i;?>" type="text" id="start_time" class="timepicker txtTime" style="width:40px;">
                          <?php //$start_time[] .= ?>
                            <br>to<br>
                          <input name="end_time_<?php echo $i;?>" type="text" id="end_time" class="timepicker txtTime" style="width:40px;">
                      </td>
                  @endfor
              </tr> -->
            </tbody>
